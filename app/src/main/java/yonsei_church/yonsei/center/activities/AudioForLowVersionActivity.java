...
public class AudioForLowVersionActivity extends AppCompatActivity implements Runnable { //, MediaPlayer.OnPreparedListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_for_low_version_audio);
       ...
       fab = findViewById(R.id.button);
        ...
        //initPlay();
        fab.setImageDrawable(ContextCompat.getDrawable(AudioForLowVersionActivity.this, R.drawable.baseline_pause_white_24));
        try {
                    ...
                    switch (focusChange) {
                        ...
                        case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK :
                            ...
                            if (mediaPlayer.isPlaying()) {
                                fab.setImageDrawable(ContextCompat.getDrawable(AudioForLowVersionActivity.this, R.drawable.baseline_play_arrow_white_24));
                                mediaPlayer.pause();
                        ...
                        case (AudioManager.AUDIOFOCUS_LOSS_TRANSIENT) :
                            ...
                            fab.setImageDrawable(ContextCompat.getDrawable(AudioForLowVersionActivity.this, R.drawable.baseline_play_arrow_white_48));
                            mediaPlayer.pause();
